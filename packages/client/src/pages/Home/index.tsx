  ...
  return (
    <div className="home text-center">
      ...
      <div className="new-join-button-wrapper mt-4">
        ...
        <Button size="lg" variant="outline-primary" onClick={joinGame}>
          Join Game
        </Button>
      </div>
      ...
      <div className="mt-5">
        ...
        {storedGames.length > 0 ? (
          <div className="active-game-cards mt-3">
            {storedGames
              .sort((a, b) => (a.time > b.time ? -1 : 1))
              .map(({ gameId, userToken, playerId, status, time, role }) => (
                <Card key={gameId} className="mb-1">
                  <Card.Body className="p-3">
                    <div className="text-left d-flex justify-content-between align-items-center mb-2">
                      <span className="font-weight-bold">Game {gameId}</span>
      ...
      <div>
        <h3>What is Monopoly Money?</h3>
        <p style={{ color: "var(--text-muted)", maxWidth: 600, margin: "1rem auto" }}>
        ...
        <div className="screenshot-grid mt-4">
      ...
      <div>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Monopoly Money is open source, meaning you can host your own uninterrupted instance.
        </p>
        <p>
